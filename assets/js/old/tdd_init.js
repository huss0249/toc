...
//import * as lang from './tdd_lang_toggle.js';
import {extractTOC} from './tdd_lang_toggle.js';

import * as dictionary from './tdd_dictionary.js';
import {tdd_dictionary} from './tdd_dictionary.js';
//import log from './_assets/js/tdd_reusable.js';

import * as saba from './tdd_saba.js'
import * as listeners from './tdd_listeners.js'
...
//export const $pageDiv = document.getElementById("pageDIV")

export const $modal_options = document.createElement("div");
export const $modal_menu = document.createElement("div");
export const $navTOC = document.createElement("div");
...
const init_DOM = () => {
    ...
    ======================================================
    */
//    reuse.log(null, 'start fn ------------------> init_DOM');
   log(null, 'start fn ------------------> init_DOM');
...
//    globalThis.$body = document.body;
	  ...
	  $body ? log(null, JSON.stringify($body.children, null, ' '), 'APP =======================tdd_lang_toggle.js >>> extract TOC >> full pages') : log(null, 'NONONONONO')
//	log(null, $body, 'start fn ------------------> $body');
//
...
//    export const $navTOC = document.createElement("div");
    ...
    format_DOM_base();
//    reuse.log(null, 'close fn /////////////////// init_DOM');
...
export let init_courseInfo = () => {
    ...
    ======================================================
    */
//    reuse.log(null, 'start fn ------------------> init_courseInfo');
    log(null, 'start fn ------------------> init_courseInfo');
...
//    reuse.log(null, 'start fn ------------------> init_pageNumber');
    log(null, 'start fn ------------------> init_pageNumber');
...
//    reuse.log(null, 'start fn ------------------> init_pageNav');
    log(null, 'start fn ------------------> init_pageNav');
...
//    reuse.log(null, 'start fn ------------------> init_navOptions');
    log(null, 'start fn ------------------> init_navOptions');
...
//    reuse.log(null, 'start fn ------------------> init_Brand');
    log(null, 'start fn ------------------> init_Brand');
...
//    reuse.log(null, currentLanguage, 'current language init_Brand');
    log(null, currentLanguage, 'current language init_Brand');
    
//    $brand.src = './dnd_logo.svg';
//    let $brandSource = `../img/dnd_logo_${currentLanguage}.svg`;
    let $brandSource = `./_assets/img/dnd_logo_${currentLanguage}.svg`;
//    let $brandSource = './dnd_logo_' + currentLanguage + '.svg';
//    reuse.log(null, $brandSource);
...
//    reuse.log(null, 'start fn ------------------> init_modal_menu');
    log(null, 'start fn ------------------> init_modal_menu');
...
//    reuse.log(null, 'start fn ------------------> init_modal_options');
    log(null, 'start fn ------------------> init_modal_options');
...
//    reuse.log(null, 'start fn ------------------> init_footer_nav');
    log(null, 'start fn ------------------> init_footer_nav');
...
//    reuse.log(null, 'start fn ------------------> init_footer_bar');
    log(null, 'start fn ------------------> init_footer_bar');
...
//    reuse.log(null, 'start fn ------------------> init_Content');
    log(null, 'start fn ------------------> init_Content');
...
//    
//    reuse.log(null, 'start fn ------------------> format_DOM_base');
    log(null, 'start fn ------------------> format_DOM_base');
...
//        reuse.log('alert', '$pageDiv NOT FOUND');
        log('alert', '$pageDiv NOT FOUND');
    }

    for (const el of $pageDiv.children) {
//		reuse.log(null, $pageDiv.children, 'el $pageDiv.children');
//		reuse.log(null, el, 'el s');
...
//	reuse.log(null, 'close fn /////////////////// format_DOM_base');
	log(null, 'close fn /////////////////// format_DOM_base');
	return
}
...
//    reuse.log(null, 'start fn ------------------> fillNavBrand');
    log(null, 'start fn ------------------> fillNavBrand');
...
//    reuse.log(null, 'start fn ------------------> locale_pageNav');
    log(null, 'start fn ------------------> locale_pageNav');
...
//    reuse.log(null, 'start fn ------------------> extract_pageNav_children');
    log(null, 'start fn ------------------> extract_pageNav_children');
...
//    reuse.log(null, 'start fn ------------------> cleanup_pageNav');
    log(null, 'start fn ------------------> cleanup_pageNav');
...
//    reuse.log(null, 'start fn ------------------> updateCopyright');
    log(null, 'start fn ------------------> updateCopyright');
...
export const cleanupDOM = () => {
    ...
    */
//    reuse.log(null, '===   === === === === === ===');
//    reuse.log(null, 'start fn ------------------> cleanupDOM');
...
// ready function is called from within the module at update language action
//globalThis.ready = (callbackFunc) => {
//export const ready = (callbackFunc) => {
//	reuse.log(null, 'start fn ------------------> ready');
//    if (document.readyState !== 'loading') {
//		reuse.log(null, 'document.readyState !== loading');
//        // Document is already ready, call the callback directly
//        callbackFunc();
//    } else if (document.addEventListener) {
//		reuse.log(null, '> ready > addEventListener > DOMContentLoaded');
//        // All modern browsers to register DOMContentLoaded
//        document.addEventListener('DOMContentLoaded', callbackFunc);
//    } else {
//		reuse.log(null, ' ------------------> ready else');
//        // Old IE browsers
//        document.attachEvent('onreadystatechange', function() {
//            if (document.readyState === 'complete') {
//				reuse.log(null, 'readyState === complete');
//                callbackFunc();
//            }
//        });
//    }
...
export const ready = (callbackFunc) => {
    document.readyState !== 'loading' ? callbackFunc() :
    document.addEventListener ? document.addEventListener('DOMContentLoaded', callbackFunc) : 
	document.attachEvent('onreadystatechange', function() { document.readyState === 'complete' ? callbackFunc() : null } );
}
...
//    reuse.log('log', lang, 'start fn ------------------> modifyDOM with lang');
    log(null, 'start fn ------------------> modifyDOM');
    
//    if (lang) {
//        globalThis.currentLanguage = lang;
//    } else {
//        reuse.log('alert', 'lang NOT FOUND');
//    }
...
//        reuse.log('alert', 'lang NOT FOUND')
        log('alert', 'lang NOT FOUND')
    }
//    lang ? globalThis.currentLanguage = lang : reuse.log('alert', 'lang NOT FOUND');
//    lang ? currentLanguage = lang : reuse.log('alert', 'lang NOT FOUND');
	
//	reuse.log(null, currentLanguage, 'currentLanguage');
	log(null, currentLanguage, 'set global currentLanguage from modifyDOM fn @ init');
